...
const DiagnosticPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await api.post('/api/diagnostic/submit', { answers: answersArray })
      setResult(res.data)
      setUser(prev => ({ ...prev, diagnosticDone: true, tier: res.data.tier }))
    } catch {
  ...
  if (result) {
    return (
      <div style={{ maxWidth: 480, margin: '80px auto', padding: 32, textAlign: 'center' }}>
        <h2 style={{ marginBottom: 8 }}>Pre-Test Complete!</h2>
        ...
        <div style={{
          ...
          <div style={{
            ...
            backgroundColor: '#3b3b5c', color: '#fff',
